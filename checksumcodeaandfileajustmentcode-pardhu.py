...
volume_csv = 'BD_Motor_front_Faults_April_June.csv'
fid_csv = 'Sevcon controller fault codes_Fault Codes.csv'
output_csv = 'BD_Motor_front_Faults.csv'
...
volume_df['Hex Code'] = volume_df['Hex Code'].str.upper()
...
output_columns = [
    ...
    'Year',
    'Time_Only',
    'controller_fault_status_2_FRONT.motorcontroller_2 fault_code',  # Ensure this column exists
